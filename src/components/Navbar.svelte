<script>
  ...
  onMount(() => {
    ...
    if (localData === null) {
      AuthStore.update((data = data = null));

      UserStore.update((data = data = null));
    } else {
      ...
      AuthStore.subscribe(data => {
        ...
        .then((res)=>{
          UserStore.update((data => data = res.data))
        })
          ...
          <ul class="navbar-nav mx-auto align-items-lg-center">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item" href="index.html">Landing Overview</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="landing-sass-v1.html"
                    >Saas v.1</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="landing-sass-v2.html"
                    >Sass v.2</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="landing-accounting.html"
                    >Accounting</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="landing-finance.html"
                    >Finance</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="landing-jamstack-agancy.html"
                    >Jamstack Agency</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="landing-conference.html"
                    >Conference</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="landing-personal.html"
                    >Personal</a
                  >
                </li>
              </ul>
                  ...
                  <div class="col">
                    <div>
                      <div>
                        ...
                        <a class="dropdown-item" href="blog-list-view.html"
                          >List View</a
                        >
                        <a class="dropdown-item" href="blog.html">Grid View</a>
                        <a class="dropdown-item" href="blog-grid-thumbnail.html"
                          >Grid View v.2</a
                        >
                  ...
                  <div class="col">
                    <div class="mt-3 mt-lg-0">
                      <div>
                        ...
                        <a class="dropdown-item" href="service-v1.html"
                          >Service v.1</a
                        >
                        <a class="dropdown-item" href="service-v2.html"
                          >Service v.2</a
                        >
                        <a class="dropdown-item" href="service-v3.html"
                          >Service v.3</a
                        >
                      </div>
                      <div class="mt-3">
                      ...
                      <div class="mt-3">
                        ...
                        <a class="dropdown-item" href="contact-1.html"
                          >Contact Us</a
                        >
                        <a class="dropdown-item" href="contact-2.html"
                          >Contact Sales</a
                        >
                      </div>
                    </div>
                  ...
                  <div class="col">
                    <div class="mt-3 mt-lg-0">
                      ...
                      <div class="mt-3">
                        ...
                        <a class="dropdown-item" href="pricing-v1.html"
                          >Pricing v.1</a
                        >
                        <a class="dropdown-item" href="pricing-v2.html"
                          >Pricing v.2</a
                        >
                      </div>
                      <div class="mt-3">
                    ...
                    <div class="mt-3 mt-lg-0">
                      <div>
                        ...
                        <a class="dropdown-item" href="integration.html"
                          >Grid View</a
                        >
                        <a class="dropdown-item" href="integration-single.html"
                          >Single</a
                        >
                      </div>
                    </div>
            ...
            <li class="nav-item dropdown dropdown-fullwidth">
              ...
              <div class="dropdown-menu p-4">
                <div class="row row-cols-xl-6 row-cols-lg-5 row-cols-1 gx-lg-4">
                  <div class="col">
                    <a
                      class="dropdown-item d-block px-0 mb-lg-3"
                  ...
                  <div class="col">
                    ...
                    >
                      <div
                        class="rounded d-none d-lg-block mb-lg-2 bg-gray-200"
                      >
                        <img
                          class="w-100 rounded-2"
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  <a class="dropdown-item" href="account-team.html">Team</a>
                </li>
                <li>
                  <a class="dropdown-item" href="account-notification.html"
                    >Notifications</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="account-app-integration.html"
                    >Integration</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="account-device-session.html"
                    >Session</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="account-social-links.html"
                    >Social</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="account-appearance.html"
                    >Appearance</a
                  >
                </li>
                <li class="dropdown-submenu dropend">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a class="dropdown-item" href="otp-varification.html"
                        >OTP Varification</a
                      >
                    </li>
                    ...
                    <li>
                      <a class="dropdown-item" href="forget-password-v2.html"
                        >Forget Password</a
                      >
                    </li>
                    <li>
                      <a class="dropdown-item" href="reset-password-v2.html"
                        >Reset Password</a
                      >
                    </li>
                    <li>
                      <a class="dropdown-item" href="otp-varification-v2.html"
                        >OTP Varification</a
                      >
                    </li>
                  </ul>
