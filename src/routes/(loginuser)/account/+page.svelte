       ...
       <div class="container">
          <div class="row">
             ...
             <div class="col-lg-9 col-md-8">
                <div class="mb-4">
                   <h1 class="mb-0 h3">Hey, {$UserStore?.username}! Welcome to Block.</h1>
                ...
                <div class="row mb-5 g-4">
                   <div class="col-lg-4 col-md-6">
                      <div class="card border-0 shadow-sm">
                         <div class="card-body">
                            <span>Balance</span>
                            <h3 class="mb-0 mt-4">NGN {$UserStore?.wallet}</h3>
                         </div>
                      </div>
                   </div>
                   <div class="col-lg-4 col-md-6">
                      <div class="card border-0 shadow-sm">
                         <div class="card-body">
                            ...
                            <h3 class="mb-0 mt-4">NGN 4356</h3>
                         </div>
                      </div>
                   </div>
                   <div class="col-lg-4 col-md-6">
                      <div class="card border-0 shadow-sm">
                         <div class="card-body">
                            ...
                            <h3 class="mb-0 mt-4">NGN {$UserStore?.task_earning}</h3>
                         </div>
                      </div>
                   </div>
                </div>
