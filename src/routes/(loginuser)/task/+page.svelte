           ...
           <SideBar />
            <div class="col-lg-9 col-md-8">
               <div class="row mb-5">
                  ...
                  <div class="col-lg-4 col-md-4 col-12 ">
                     <ul class="nav d-flex gap-1 justify-content-md-start mt-3 mt-md-0">
                         <li>
                             <a class="btn btn-secondary  btn-sm" href="blog.html">
                                 all
                        ...
                        <li>
                           <a class="btn btn-light  btn-sm" href="blog-grid-thumbnail.html">
                             verified
                        ...
                        <li>
                           <a class="btn btn-light  btn-sm" href="blog-list-view.html">
                             unverified
               ...
               <div class="row gy-lg-7 gy-5">
                  <article class="col-lg-3 col-md-6 ml-1 col-6 ">
                     ...
                     <h3 class=" fs-10 h4">
                        <small href="blog-single.html" class="text-reset fs-10">Introducing Block Bootstrap 5 based design in 2024</small>
                     </h3>
                     <div class="d-flex align-items-center justify-content-between mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                           ...
                           <div class="ms-2">
                              <a href="#" class="text-reset fs-10">Sandip Chauhan</a>
                           </div>
                        </div>
                  ...
                  <article class="col-lg-3 col-md-6 ml-1 col-6 ">
                     ...
                     <h3 class="mb-1 fs-10 h4">
                        <small href="blog-single.html" class="text-reset fs-10">The writing trends that will define 2023 (Get Excited)</small>
                     </h3>
                     <div class="d-flex align-items-center justify-content-between mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                           <img src="assets/images/avatar/avatar-7.jpg" alt="Avatar" class="avatar avatar-xs rounded-circle" />
                           <div class="ms-2">
                              <a href="#" class="text-reset fs-10"><h3 class="fs-10">Jitu Chauhan</h3></a>
                           </div>
                        </div>
                        <div class="ms-3"><h3 class="fs-10">Dec 11, 2023</h3></div>
                     </div>
                  </article>
