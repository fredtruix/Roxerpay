...
<main>
    ...
    <section class="py-lg-7 py-5 bg-light-subtle my-5">
        <div class="container">
           <div class="row">
              <SideBar />
              <div class="col-lg-9 col-md-8">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body p-lg-5">
                       <div class="mb-5">
                          <h4 class="mb-1">Task "{ task.title }" created by</h4>
                          <h3>Description</h3>
                          <p class="fs-6 mb-0">{ task.description}</p>
                       </div>
                             ...
                             <div class="d-flex align-items-start">
                                ...
                                <div class="d-lg-flex align-items-center justify-content-between w-100">
                                   <div class="d-flex">
                                      ...
                                      <div class="ms-4">
                                         <h5 class="mb-0">Time is within { task.number } {task.period}</h5>
                                         <small class="text-warning">Payment is {#if task.pay=true } automatic after completion {:else} manual after task comfirmation {/if}</small>
                                      </div>
                                   </div>
                             ...
                             <div class="d-flex align-items-start">
                                ...
                                <div class="d-lg-flex align-items-center justify-content-between w-100">
                                   ...
                                   <div class="mt-4 mt-lg-0">
                                      <a href="#" class="btn btn-light btn-sm" data-bs-toggle="collapse" data-bs-target="#collapseDeviceTwo" aria-expanded="false" aria-controls="collapseDeviceTwo">
                                         See More
                                      </a>
                                   </div>
                                </div>
                             ...
                             <div id="collapseDeviceTwo" class="accordion-collapse collapse show" data-bs-parent="#accordionExampleOne">
                                <div class="pt-4">
                                   <div class="mb-4">
                                      ...
                                      <small>{ task.task_owner_name}</small>
                                   </div>
                                   <div class="mb-4">
                                      <h6 class="mb-0">t:</h6>
                                      <small>Ahmedabad, Gujarat, India</small>
